...
export type ARCameraNavigatieFlowProps = {
  /** Terug naar vorige scherm (stack) i.p.v. interne startpagina. */
  onExit?: () => void;
  /** Startscherm van de flow (embedded: vaak `select`). */
  initialScreen?: Screen;
};

export function ARCameraNavigatieFlow({
  onExit,
  initialScreen = 'home',
}: ARCameraNavigatieFlowProps) {
